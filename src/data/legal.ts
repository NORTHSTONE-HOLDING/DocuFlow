...
export const LEGAL_DOCUMENTS: LegalDocument[] = [
  {
    ...
    shortTitle: 'VOP',
    filename: 'PaperFlow-VOP',
    updatedAt: '2026-07-22',
    sections: [
      {
        heading: '1. Úvodní ustanovení',
        body: `Tyto Všeobecné obchodní podmínky (dále jen „VOP“) upravují práva a povinnosti mezi provozovatelem aplikace PaperFlow a uživatelem při užívání webové aplikace, registraci účtu a využívání tarifů Free, Premium, Business a Full Enterprise.
...
Uzavřením smlouvy o užívání služby (registrací účtu a/nebo úhradou předplatného) uživatel potvrzuje, že se s těmito VOP seznámil a souhlasí s nimi.`,
      },
      {
        ...
        body: `PaperFlow umožňuje vytváření, úpravu, ukládání a sdílení obchodních dokumentů (cenové nabídky, smlouvy, faktury, protokoly), včetně volitelných funkcí AI asistence, ARES lookup a souvisejících nástrojů dle zvoleného tarifu.
...
Aktualizace VOP nabývá účinnosti zveřejněním v aplikaci. Pokračováním v užívání služby po zveřejnění změny uživatel s novým zněním souhlasí, nevyžaduje-li zákon výslovný souhlas.`,
  ...
  },
  {
    ...
    shortTitle: 'GDPR',
    filename: 'PaperFlow-GDPR-Informace',
    updatedAt: '2026-07-22',
    sections: [
      {
...
Subjekt údajů má právo na přístup, opravu, výmaz, omezení zpracování, přenositelnost, námitku a právo podat stížnost u ÚOOÚ (www.uoou.cz). Souhlas se zasíláním obchodních sdělení lze kdykoli odvolat.`,
  ...
  },
  {
    ...
    filename: 'PaperFlow-Souhlas-zpracovani-OU',
    updatedAt: '2026-07-22',
    sections: [
      {
        heading: '1. Předmět souhlasu',
        body: `Uděluji správci osobních údajů (provozovateli aplikace PaperFlow) souhlas se zpracováním mých osobních údajů v rozsahu nezbytném pro registraci uživatelského účtu, plnění smlouvy o poskytování služby a řádné fungování aplikace, a to v souladu s GDPR a zákonem č. 110/2019 Sb.
...
Souhlas, je-li právním základem nad rámec plnění smlouvy, mohu odvolat zasláním žádosti na kontakt správce; odvolání nemá vliv na zákonnost zpracování před odvoláním ani na zpracování nezbytné pro plnění smlouvy.`,
  ...
  },
  {
    ...
    filename: 'PaperFlow-Souhlas-obchodni-sdeleni',
    updatedAt: '2026-07-22',
    sections: [
      {
        heading: '1. Předmět souhlasu',
        body: `Uděluji správci (provozovateli PaperFlow) dobrovolný a odvolatelný souhlas se zasíláním obchodních sdělení, novinek o produktu, tipů k používání aplikace a marketingových nabídek týkajících se služeb PaperFlow na e-mailovou adresu uvedenou při registraci, a to v souladu se zákonem č. 480/2004 Sb., o některých službách informační společnosti, a GDPR (čl. 6 odst. 1 písm. a)).`,
      },
      {
        heading: '2. Dobrovolnost',
        body: `Tento souhlas není podmínkou registrace ani užívání základní funkcionality služby. Jeho neudělení nemá vliv na uzavření či plnění smlouvy o poskytování PaperFlow.`,
      },
      {
...
• žádostí na e-mail podpora@paperflow.cz,
...
Odvolání je účinné bez zbytečného odkladu a nemá vliv na zákonnost zpracování před odvoláním.`,
  ...
  {
    id: 'userGuide',
    title: 'Návod k použití PaperFlow',
    shortTitle: 'Návod k použití',
    filename: 'PaperFlow-Navod-k-pouziti',
    updatedAt: '2026-07-22',
    sections: [
      {
        heading: '1. Úvod',
        body: `PaperFlow je jednotný ERP a dokumentový workflow pro české OSVČ, řemeslníky a firmy. Tento návod popisuje základní postupy v aplikaci — od registrace přes zakázkový pipeline až po inkasní nástroje.`,
      },
      {
      ...
      {
        heading: '6. Podpora',
        body: `Technická podpora: podpora@paperflow.cz. Provozovatel: PaperFlow Systems s.r.o., IČO 4205190.`,
      },
    ],
  },
];
...
export function legalDocumentPlainText(doc: LegalDocument): string {
  const lines = [
    doc.title,
    `PaperFlow · Verze ke dni ${doc.updatedAt}`,
    '',
    ...doc.sections.flatMap((s) => [s.heading, '', s.body, '']),
    '— Konec dokumentu —',
    'Tento soubor je elektronickým výpisem právního textu aplikace PaperFlow (simulace stažení PDF/DOCX).',
  ];
  return lines.join('\n');
}
